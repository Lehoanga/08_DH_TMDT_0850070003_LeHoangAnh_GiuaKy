...
class CardHaWidget extends StatefulWidget {
  const CardHaWidget({
    Key? key,
  ...
  @override
  _CardHaWidgetState createState() => _CardHaWidgetState();
}

class _CardHaWidgetState extends State<CardHaWidget> {
